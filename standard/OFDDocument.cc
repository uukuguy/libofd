...
//class OFDDocument::ImplCls{
//public:
    //ImplCls(OFDDocument *ofdDocument, PackagePtr package, const std::string &docRoot);
    //~ImplCls();
...
//OFDDocument::ImplCls::ImplCls(OFDDocument *ofdDocument, PackagePtr package, const std::string &docRoot) : 
    //m_ofdDocument(ofdDocument), m_package(package), m_opened(false){
...
//void OFDDocument::ImplCls::Init_After_Construct(){
    ...
    ////m_commonData.PublicRes = std::make_shared<OFDRes>(m_package.lock(), nullptr, nullptr);
    ////m_commonData.PublicRes = std::make_shared<OFDRes>(m_package.lock());
    ////m_commonData.PublicRes = OFDRes::CreateNewRes(m_package.lock());
    ////LOG(INFO) << "-------- 1 -------";
    ...
    ////}
    ////OFDPackagePtr opp = m_ofdDocument->GetPackage();
    ////LOG(INFO) << "-------- 1.3 -------";
...
//OFDDocument::OFDDocument(PackagePtr package, const std::string &docRoot){
    //m_impl = std::unique_ptr<ImplCls>(new ImplCls(this, package, docRoot));
//}
...
//const PackagePtr OFDDocument::GetPackage() const{
    //return m_impl->m_package.lock();
//}

//PackagePtr OFDDocument::GetPackage() {
    //return m_impl->m_package.lock();
//}
...
//OFDDocumentPtr OFDDocument::CreateNewDocument(PackagePtr package, const std::string &docRoot){
    //OFDDocumentPtr document = std::shared_ptr<OFDDocument>(new OFDDocument(package, docRoot));
